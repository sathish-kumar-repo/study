  ...
  return (
    <Animated>
      ...
      <p>
        ...
        regulations for using our website, accessible at [your website URL]. By
        accessing or using Study, you agree to comply with these terms. If you
        do not agree with any part of these terms, please discontinue use of our
        website.
      </p>
      ...
      <p>
        ...
        notes, tutorials, text, graphics, logos, and images, is the intellectual
        property of Study unless otherwise stated. Unauthorized use,
        reproduction, or distribution of our content is strictly prohibited.
      </p>

      <h2>2. Use of Website</h2>
      <p>
        You may use Study for personal and educational purposes only. You agree
        not to:
      </p>
      <ul>
      ...
      <p>
        Study may contain links to third-party websites. We are not responsible
      ...
      <h2>5. Disclaimer</h2>
      <p>
        The content provided on Study is for informational purposes only. While
      ...
      <p>
        ...
        arising from your use of the website or its content. This includes, but
