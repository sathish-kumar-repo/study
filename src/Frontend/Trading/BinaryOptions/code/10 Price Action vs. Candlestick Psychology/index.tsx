import { Title, H1, Para, List, Table } from "../../../../../Backend/UI";
      ...
      <List
        items={[
          ...
          <span>
            ...
            <b>
              chart patterns, support & resistance, trendlines, breakouts, and
              market structure
            </b>{" "}
          ...
          <span>
            ...
            <b>
              market structure (higher highs, lower lows), momentum, liquidity
              zones, and institutional moves
            </b>{" "}
            rather than just individual candlesticks.
          </span>,
          <span>
            Example: If price forms a <b>double bottom at strong support</b>, a
            price action trader looks for confirmation (higher highs forming)
      ...
      <List
        items={[
          <span>
            ...
            <b>story behind each candlestick</b> — who is in control (buyers or
            sellers) and what emotions are driving the price.
          </span>,
          <span>
            Traders analyze the{" "}
          ...
          <span>
            ...
            shows rejection of lower prices, indicating buyers are stepping in.
          </span>,
        ]}
      />
