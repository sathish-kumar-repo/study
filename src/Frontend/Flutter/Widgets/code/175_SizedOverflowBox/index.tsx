...
const SizedOverflowBoxWidget = () => {
  return (
    <>
      ...
      <List
        items={[
          ...
          <>
            ...
            <A link="https://github.com/sathish-kumar-repo/flutter_widgets_live/blob/main/lib/widgets/Widgets175_SizedOverflowBox.dart">
              GitHub
            </A>
            .
          </>,
      ...
      <Syntax
        customDomain={domain}
        src="Widgets175_SizedOverflowBox.dart"
        language="dart"
      />
    </>
  );
