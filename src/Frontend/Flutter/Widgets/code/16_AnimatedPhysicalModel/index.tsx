...
const AnimatedPhysicalModelWidget = () => {
  return (
    <>
      ...
      <List
        items={[
          ...
          <>
            ...
            <A link="https://github.com/sathish-kumar-repo/flutter_widgets_live/blob/main/lib/widgets/Widgets16_AnimatedPhysicalModel.dart">
              GitHub
            </A>
            .
          </>,
      ...
      <Syntax
        customDomain={domain}
        src="Widgets16_AnimatedPhysicalModel.dart"
        language="dart"
      />
    </>
  );
