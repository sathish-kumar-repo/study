...
const Selector = () => {
  return (
    <>
      ...
      <List items={["Element( tagname)", "Class (.)", "D (#)", "Universal"]} />
      <H2>2. Combinators Selectors</H2>
      <List
        items={[
          "Descendant",
          "Direct child",
      ...
      />
      <H2>3. Attribute selectors</H2>
      <H2>4. Pseudo Class selectors</H2>
      <H2>5. Pseudo element selectors</H2>
      <Para>
